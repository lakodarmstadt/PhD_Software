...
frequency_list_D1 = [[n, atom.getTransitionFrequency(5, 1, 0.5, n, 0, 0.5) * 1e9, atom.getTransitionFrequency(5, 1, 0.5, n, 1, 0.5) * 1e9, atom.getTransitionFrequency(5, 1, 0.5, n, 1, 1.5) * 1e9, atom.getTransitionFrequency(5, 1, 0.5, n, 2, 1.5) * 1e9, atom.getTransitionFrequency(5, 1, 0.5, n, 2, 2.5) * 1e9] for n in range(nmin, nmax)]
fund_frequency_list_D1 = [[n, a / 2, b / 2, c / 2, d / 2, e / 2] for [n, a, b, c, d, e] in frequency_list_D1]
df_D1 = pd.DataFrame(fund_frequency_list_D1, columns=['n', 'nS12', 'nP12', 'nP32', 'nD32', 'nD52'])
df_D1.to_csv('Transitionfrequencies_D1.csv')

frequency_list_D2 = [[n, atom.getTransitionFrequency(5, 1, 1.5, n, 0, 0.5) * 1e9, atom.getTransitionFrequency(5, 1, 1.5, n, 1, 0.5) * 1e9, atom.getTransitionFrequency(5, 1, 1.5, n, 1, 1.5) * 1e9, atom.getTransitionFrequency(5, 1, 1.5, n, 2, 1.5) * 1e9, atom.getTransitionFrequency(5, 1, 1.5, n, 2, 2.5) * 1e9] for n in range(nmin, nmax)]
fund_frequency_list_D2 = [[n, a * 2, b * 2, c * 2, d * 2, e * 2] for [n, a, b, c, d, e] in frequency_list_D2]
df_D2 = pd.DataFrame(fund_frequency_list_D2, columns=['n', 'nS12', 'nP12', 'nP32', 'nD32', 'nD52'])
df_D2.to_csv('Transitionfrequencies_D2.csv')
